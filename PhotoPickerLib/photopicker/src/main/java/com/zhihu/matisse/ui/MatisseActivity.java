...
public class MatisseActivity extends AppCompatActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (SelectionSpec.getInstance().profilePhotoMode) mBottomToolbar.setVisibility(View.GONE);
    ...
    private void handleCropResult(@NonNull Intent data) {
        ...
        if (resultUri != null) {
            ...
            setResult(RESULT_OK, result);
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP)
                MatisseActivity.this.revokeUriPermission(resultUri,
                        Intent.FLAG_GRANT_WRITE_URI_PERMISSION | Intent.FLAG_GRANT_READ_URI_PERMISSION);
            finish();
        }
    }
    ...
    public void onMediaClick(Album album, Item item, int adapterPosition) {
        if (!SelectionSpec.getInstance().profilePhotoMode) {

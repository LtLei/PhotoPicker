...
public final class SelectionCreator {
    ...
    /**
     * 是否选择头像模式，如果使用头像模式，则设置最大选择数，以及是否显示数字等无效，效果类似于微信
     *
     * @param isProfilePhotoMode
     * @return
     */
    public SelectionCreator useProfilePhotoMode(boolean isProfilePhotoMode) {
        mSelectionSpec.profilePhotoMode = isProfilePhotoMode;
        return this;
    }
     ...
     * @return
     */
    public SelectionCreator setCropOptions(@NonNull UCrop.Options cropOptions) {
    ...
    public SelectionCreator setProfileFileName(@NonNull String fileName) {
        ...
        mSelectionSpec.profileFileName = fileName;
        return this;
    }

    public SelectionCreator setCropRatio(float x, float y) {
        mSelectionSpec.cropX = x;
        mSelectionSpec.cropY = y;
        return this;
    }

    public SelectionCreator setCropMaxResultSize(int width, int height) {
